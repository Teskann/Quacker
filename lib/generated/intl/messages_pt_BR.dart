...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(name) => "Tem certeza de que deseja excluir o grupo de inscrições ${name}?";
  ...
  static m5(snapshotData) => "Terminou com ${snapshotData} usuários";

  static m6(name) => "Grupo: ${name}";

  static m7(snapshotData) => "${snapshotData} usuários importados até agora";
  ...
  static m10(errorMessage) => "Por favor, verifique sua conexão à internet.\n\n${errorMessage}";

  static m11(releaseVersion) => "Toque para baixar ${releaseVersion}";

  static m12(getMediaType) => "Toque para mostrar ${getMediaType}";

  static m13(filePath) => "O arquivo não existe. Certifique-se de que está localizado em ${filePath}";
  ...
  static m17(responseStatusCode) => "Não foi possível salvar a mídia. O Twitter retornou um status de ${responseStatusCode}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "add_subscriptions" : MessageLookupByLibrary.simpleMessage("Adicionar inscrições"),
    ...
    "could_not_find_any_tweets_by_this_user" : MessageLookupByLibrary.simpleMessage("Não foi possível encontrar nenhum tweet deste usuário!"),
    ...
    "disable_screenshots" : MessageLookupByLibrary.simpleMessage("Desabilitar capturas de tela"),
    "disable_screenshots_hint" : MessageLookupByLibrary.simpleMessage("Previne que sejam feitas capturas de tela. Isso pode não funcionar em todos os dispositivos."),
    "disabled" : MessageLookupByLibrary.simpleMessage("Desativado"),
    "donate" : MessageLookupByLibrary.simpleMessage("Doar"),
    "download" : MessageLookupByLibrary.simpleMessage("Download"),
    "download_handling" : MessageLookupByLibrary.simpleMessage("Manipulação de downloads"),
    "download_handling_description" : MessageLookupByLibrary.simpleMessage("Como o download deve funcionar"),
    "download_handling_type_ask" : MessageLookupByLibrary.simpleMessage("Sempre perguntar"),
    "download_handling_type_directory" : MessageLookupByLibrary.simpleMessage("Salvar no diretório"),
    "download_media_no_url" : MessageLookupByLibrary.simpleMessage("Incapaz de baixar. Esta mídia pode estar disponível apenas como uma transmissão, que Quacker ainda não pode baixar."),
    "download_path" : MessageLookupByLibrary.simpleMessage("Caminho do download"),
    ...
    "functionality_unsupported" : MessageLookupByLibrary.simpleMessage("Esta funcionalidade não é mais suportada pelo Twitter!"),
    ...
    "let_the_developers_know_if_something_is_broken" : MessageLookupByLibrary.simpleMessage("Deixe os desenvolvedores saberem se algo está quebrado"),
    ...
    "open_app_settings" : MessageLookupByLibrary.simpleMessage("Abrir as configurações do aplicativo"),
    ...
    "please_note_that_the_method_fritter_uses_to_import_subscriptions_is_heavily_rate_limited_by_twitter_so_this_may_fail_if_you_have_a_lot_of_followed_accounts" : MessageLookupByLibrary.simpleMessage("Observe que o método que o Quacker usa para importar inscrições é fortemente limitado pelo Twitter, portanto, isso pode falhar se você estiver seguindo muitas contas."),
    "possibly_sensitive" : MessageLookupByLibrary.simpleMessage("Potencialmente sensível"),
    "possibly_sensitive_profile" : MessageLookupByLibrary.simpleMessage("Este perfil pode conter imagens, idiomas, ou outros conteúdos potencialmente sensíveis. Você ainda quer vê-lo?"),
    "possibly_sensitive_tweet" : MessageLookupByLibrary.simpleMessage("Este tweet contém conteúdo potencialmente sensível. Você gostaria de vê-lo?"),
    ...
    "saved_tweet_too_large" : MessageLookupByLibrary.simpleMessage("Este tweet salvo não pôde ser exibido porque é muito grande para carregar. Por favor, denuncie aos desenvolvedores."),
    ...
    "share_tweet_content_and_link" : MessageLookupByLibrary.simpleMessage("Compartilhar conteúdo e link do tweet"),
    ...
    "something_just_went_wrong_in_fritter_and_an_error_report_has_been_generated" : MessageLookupByLibrary.simpleMessage("Algo deu errado no Quacker e um relatório de erro foi gerado. O relatório pode ser enviado aos desenvolvedores do Quacker para ajudar a corrigir o problema."),
    ...
    "this_took_too_long_to_load_please_check_your_network_connection" : MessageLookupByLibrary.simpleMessage("Isso demorou muito para carregar. Verifique sua conexão de rede!"),
    ...
    "this_user_does_not_have_anyone_following_them" : MessageLookupByLibrary.simpleMessage("Este usuário não tem nenhum seguidor!"),
    ...
    "to_import_subscriptions_from_an_existing_twitter_account_enter_your_username_below" : MessageLookupByLibrary.simpleMessage("Para importar assinaturas de uma conta existente do Twitter, digite seu nome de usuário abaixo."),
    ...
    "tweets_number" : m15,
    "two_home_pages_required" : MessageLookupByLibrary.simpleMessage("Você precisa ter pelo menos 2 páginas iniciais."),
    ...
    "unable_to_find_your_saved_tweets" : MessageLookupByLibrary.simpleMessage("Não foi possível encontrar seus tweets salvos."),
    "unable_to_import" : MessageLookupByLibrary.simpleMessage("Não foi possível importar"),
    "unable_to_load_home_pages" : MessageLookupByLibrary.simpleMessage("Não foi possível carregar suas páginas iniciais"),
    ...
    "when_a_new_app_update_is_available" : MessageLookupByLibrary.simpleMessage("Quando uma nova atualização do aplicativo está disponível"),
    ...
    "which_tab_is_shown_when_the_app_opens" : MessageLookupByLibrary.simpleMessage("Qual aba é mostrada quando o aplicativo é aberto"),
    ...
    "you_have_not_saved_any_tweets_yet" : MessageLookupByLibrary.simpleMessage("Você ainda não salvou nenhum tweet!"),
    "you_must_have_at_least_2_home_screen_pages" : MessageLookupByLibrary.simpleMessage("Você deve ter pelo menos 2 páginas de tela inicial"),
    "your_profile_must_be_public_otherwise_the_import_will_not_work" : MessageLookupByLibrary.simpleMessage("Seu perfil deve ser público, caso contrário a importação não funcionará"),
    "your_report_will_be_sent_to_quacker_glitchtip_project" : MessageLookupByLibrary.simpleMessage("Seu relatório será enviado para o projeto  do Quacker, e os detalhes de privacidade podem ser encontrados em:")
  };
}
